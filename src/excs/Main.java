...
public class Main {
    public static void main(String... args) {
        ...
        //System.out.println("Average page number of " + author.getName() + " is "+author.getAvgPageNumber());
        ...
        //System.out.println("Average page number of " + anotherAuthor.getName() + " is "+anotherAuthor.getAvgPageNumber());
